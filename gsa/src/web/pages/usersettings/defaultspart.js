  ...
  return (
    <React.Fragment>
      {capabilities.mayAccess('alert') && (
        <FormGroup title={_('默认警报')} titleSize="3">
          <Select
            name="defaultAlert"
            value={defaultAlert}
      ...
      {capabilities.mayAccess('credential') && (
        <FormGroup title={_('默认ESXi凭据')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('scanconfig') && (
        <FormGroup title={_('默认OSP扫描配置')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('scanner') && (
        <FormGroup title={_('默认OSP扫描仪')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('scanconfig') && (
        <FormGroup title={_('默认的OpenVAS扫描配置')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('scanner') && (
        <FormGroup title={_('默认的OpenVAS扫描仪')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('portlist') && (
        <FormGroup title={_('默认端口列表')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('reportformat') && (
        <FormGroup title={_('默认报告格式')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('credential') && (
        <FormGroup title={_('默认SMB凭据')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('credential') && (
        <FormGroup title={_('默认SNMP凭据')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('credential') && (
        <FormGroup title={_('默认SSH凭据')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('schedule') && (
        <FormGroup title={_('默认计划')} titleSize="3">
          <Select
      ...
      {capabilities.mayAccess('target') && (
        <FormGroup title={_('默认目标')} titleSize="3">
          <Select
            name="defaultTarget"
            value={defaultTarget}
