      ...
      <InfoTable>
        ...
        <TableBody>
          {isDefined(entity.openTime) && (
            <React.Fragment>
              <TableRow>
                <TableData>{_('开放')}</TableData>
                <TableData>{longDate(entity.openTime)}</TableData>
              </TableRow>
              <TableRow>
                <TableData>{_('注释')}</TableData>
                <TableData>
