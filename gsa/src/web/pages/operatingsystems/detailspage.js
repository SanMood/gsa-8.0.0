    ...
    <Divider margin="10px">
      <IconDivider>
        <ManualIcon
          ...
          title={_('帮助：操作系统')}
        />
        <ListIcon title={_('操作系统列表')} page="operatingsystems" />
      </IconDivider>
      <IconDivider>
