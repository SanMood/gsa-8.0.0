  ...
  handlePublicKeyChange(file) {
    ...
    reader.onload = e => {
      ...
      if (result.startsWith(PGP_PUBLIC_KEY_LINE)) {
        ...
        this.setState({error: _('不是有效的PGP文件')});
      }
    };
