    ...
    <Divider margin="15px">
      <IconDivider>
        <ManualIcon
          ...
          title={_('帮助：报告')}
        />
        <ListIcon title={_('报告列表')} page="reports" />
      </IconDivider>
      {!loading && (
        <React.Fragment>
          <IconDivider>
            <AddToAssetsIcon
              title={_('添加到QoD=>70%且启用复写的资产')}
            ...
            <TabLayout grow="1" align={['start', 'end']}>
              ...
              >
                ...
                {delta ? (
                  ...
                  <Tab>
                    <TabTitle title={_('结果')} counts={resultCounts} />
                  </Tab>
                )}
                {!delta && (
                  <Tab>
                    <TabTitle title={_('主机')} counts={hosts.counts} />
                  </Tab>
                )}
                {!delta && (
                  <Tab>
                    <TabTitle title={_('端口')} counts={ports.counts} />
                  </Tab>
                )}
                {!delta && (
                  <Tab>
                ...
                {!delta && (
                  <Tab>
                    <TabTitle title={_('CVE')} counts={cves.counts} />
                  </Tab>
                )}
                {!delta && (
                  <Tab>
