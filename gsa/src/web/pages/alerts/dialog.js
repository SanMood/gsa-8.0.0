...
export const INCLUDE_MESSAGE_DEFAULT = `任务 '$n': $e'

在事件$e之后，
满足以下条件：$c

此电子邮件升级已配置为应用报告格式'$r'。
扫描引擎上提供了完整的详细信息和其他报告格式。

$t
$i

注意：
此电子邮件是作为配置的安全扫描升级发送给您的。
如果您认为不应该收到它，请与本地系统管理员联系。`;

export const INCLUDE_MESSAGE_SECINFO = `在事件$e之后，
满足以下条件：$c
...
注意：
此电子邮件是作为配置的安全信息升级发送给您的。
如果您认为不应该收到它，请与本地系统管理员联系。`;

export const ATTACH_MESSAGE_DEFAULT = `任务 '$n': $e
...
export const ATTACH_MESSAGE_SECINFO = `在事件$e之后，
满足以下条件：$c
...
export const VFIRE_CALL_DESCRIPTION = `在事件$e之后，
满足以下条件：$c
        ...
        {({values, onValueChange}) => {
          return (
            <Layout flex="column">
              ...
              <FormGroup title={_('事件')} flex="column">
                <Divider flex="column">
                  <TaskEventPart
                    prefix="event_data"
                    event={values.event}
              ...
              <FormGroup title={_('条件')} flex="column">
                <Divider flex="column">
                  <Radio
                    title={_('始终')}
                    name="condition"
              ...
              {taskEvent && (
                <FormGroup title={_('Delta报告')} flex="column">
                  <Divider flex="column">
                    <Radio
                      title={_('无')}
