      ...
      <InfoTable>
        ...
        <TableBody>
              ...
              <TableRow>
                ...
                <TableData>
                  <DetailsLink
                    ...
                    type="report"
                  >
                    {_('报告 ')} {method.data.delta_report_id.value}
                  </DetailsLink>
                </TableData>
              </TableRow>
            )}
          ...
          <TableRow>
            ...
            <TableData>{entity.isActive() ? _('是') : _('否')}</TableData>
          </TableRow>

          {tasks.length > 0 && (
            <TableRow>
              <TableData>{_('使用此警报的任务')}</TableData>
              <TableData>
                <Divider wrap>
                  {tasks.map(task => (
