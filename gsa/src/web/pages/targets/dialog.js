      ...
      {({values: state, onValueChange}) => {
        return (
          <Layout flex="column">
            ...
            <FormGroup title={_('主机')} flex="column">
              <Divider flex="column">
                <Divider>
                  <Radio
                    title={_('手动输入')}
            ...
            <FormGroup title={_('排除主机')} flex="column">
              <Divider flex="column">
                <Divider>
                  <Radio
                    title={_('手动输入')}
