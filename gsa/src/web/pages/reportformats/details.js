  ...
  return (
    <Layout grow flex="column">
      <InfoTable>
        ...
        <TableBody>
          <TableRow>
            <TableData>{_('扩展')}</TableData>
            <TableData>{extension}</TableData>
          </TableRow>

          <TableRow>
            <TableData>{_('内容类型')}</TableData>
            <TableData>{content_type}</TableData>
          </TableRow>

          <TableRow>
            <TableData>{_('信任')}</TableData>
            <TableData>
              <Divider>
