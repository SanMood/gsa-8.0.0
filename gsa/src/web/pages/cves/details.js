...
const CVSS_PROPS = {
  cvssAccessVector: _l('访问向量'),
  cvssAccessComplexity: _l('访问复杂度'),
  cvssAuthentication: _l('身份验证'),
  cvssConfidentialityImpact: _l('机密性影响'),
  cvssIntegrityImpact: _l('完整性影响'),
  cvssAvailabilityImpact: _l('可用性影响'),
};
