  ...
  <Divider margin="10px">
    <IconDivider>
      <ManualIcon
        ...
        title={_('帮助：结果')}
      />
      <ListIcon title={_('结果列表')} page="results" />
      <ExportIcon
        value={entity}
        title={_('以XML格式导出结果')}
...
const Details = ({entity, ...props}) => {
  ...
  return (
    <Layout flex="column">
      ...
      {active_overrides.length > 0 && (
        <DetailsBlock id="overrides" title={_('复写')}>
      ...
      {active_notes.length > 0 && (
        <DetailsBlock id="notes" title={_('注释')}>
          <Divider wrap align={['start', 'stretch']} width="15px">
