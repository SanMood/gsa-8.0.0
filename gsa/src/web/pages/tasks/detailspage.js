    ...
    <Divider margin="10px">
      <IconDivider align={['start', 'start']}>
        <ManualIcon
          ...
          title={_('帮助：任务')}
        />
        <ListIcon title={_('任务列表')} page="tasks" />
        ...
        <IconDivider>
          {isDefined(entity.current_report) && (
            <DetailsLink
              ...
              title={_('来自 {{- date}}的任务 {{- name}}的当前报告', {
          ...
          {!isDefined(entity.current_report) && isDefined(entity.last_report) && (
            <DetailsLink
              ...
              title={_('来自 {{- date}}的任务 {{- name}}的上一个报告', {
