          ...
          <Layout flex="column">
            ...
            {use_openvas_scan_config && (
              <Layout flex="column" grow="1">
                <FormGroup titleSize="2" title={_('扫描配置')}>
                  <Select
                    name="config_id"
                    disabled={!change_task}
                ...
                <FormGroup titleSize="4" title={_('网络源接口')}>
                  <TextField
                    name="source_iface"
                ...
                <FormGroup titleSize="4" title={_('目标主机的订单')}>
                  <Select
                    name="hosts_ordering"
                    items={[
                      {
