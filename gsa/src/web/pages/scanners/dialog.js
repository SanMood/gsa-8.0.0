            ...
            <Layout flex="column">
              ...
              {!isGmpScannerType && (
                <React.Fragment>
                  ...
                  <FormGroup title={_('CA证书')} flex="column">
                    <Layout>
                      <Divider>
                        {is_edit && (
                          <Layout>
              ...
              <FormGroup title={_('凭据')} flex="column">
                <Divider>
                  <Select
                    name="credential_id"
