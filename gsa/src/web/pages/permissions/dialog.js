    ...
    >
      {({values: state, onValueChange}) => {
        ...
        if (state.resourceType === 'user') {
          resourceIdTitle = _('用户ID');
        } else if (state.resourceType === 'role') {
          resourceIdTitle = _('角色ID');
        } else if (state.resourceType === 'group') {
          resourceIdTitle = _('组ID');
        } else {
          resourceIdTitle = _('资源ID');
        }
        ...
        return (
          <Layout flex="column">
            ...
            <FormGroup title={_('主题')} flex="column">
              <Divider flex="column">
